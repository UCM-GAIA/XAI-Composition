...
class DicePublic(Resource):
    ...
    def post(self):
        ...
        return e1.to_json() #prueba con json.loads(e1.to_json())
...
class DicePrivate(Resource):
    ...
    def post(self):
        ...
        # Generate counterfactuals
        e1 = exp.generate_counterfactuals(query_instances=instances, total_CFs=num_cfs, desired_class=desired_class)
